...
\section{Rolle der Logik in MAS}
	...
	\begin{itemize}
		...
		\end{itemize}
		 ...
		 \begin{itemize}
		 	\item \textbf{see(s,p)}, generiert Beobachtung aus der neuen Welt (schwer siehe Vorlesung Mustererkennung und Kontextanalyse)
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\begin{description}
				\item[$\square p \Rightarrow p$] Wann immer $p$ wahr ist, folgt daraus das aktuell p gilt (Reflexiv)
				\item[$\square p \Rightarrow \diamond p$]Wann immer $p$ wahr ist, ist p auch in mindestens einer Welt wahr (Seriell)
				\item[$\square p \Rightarrow \square \square p$]Wann immer $p$ wahr ist, ist p auch immer wahr, wenn wir einen Übergang machen (transitiv)
...
\section{Kooperation von Agenten}
	...
	\begin{itemize}
		\item Ein Multiagenten System besteht aus mehren Agenten, die
		\begin{itemize}
...
\section{Agenten Kommunikation}
	...
	\begin{itemize}
		...
		\item Alle Teilnehmer haben ein gemeinsames, gleiches Verständniss von Begriffen über einer Domäne (Ontologie) d.h. jeder Teilnehmer weiß genau, was unter einem bestimmten Begriff zu verstehen ist
		...
		\item Ontologie-Sprachen erlauben dem Nutzer eine explizite und formale Konzeptionierung der Domäne
